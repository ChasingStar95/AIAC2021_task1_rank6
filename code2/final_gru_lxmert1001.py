...
from modules import LXRTXLayer, SpatialDropout
...
SAVE_PATH = '../final_output/gru_lxmert1001'
...
if DISTILL_TRAIN2:
    ...
    for _fold, (train_idx, valid_idx) in enumerate(kf.split(label_df, label_df)):
        ...
        lr = even_mults(LR / 2, LR, 6)

        optimizer_parameters = [
            {'params': model.module.pointwise_module.module.WordEmb.parameters(), 'lr': lr[0]}, # video_linear
            ...
            {'params': list(model.module.pointwise_module.module.cross_encoder.children())[0].parameters(), "lr": lr[2]},
            {'params': list(model.module.pointwise_module.module.cross_encoder.children())[1].parameters(), "lr": lr[3]},
            {'params': list(model.module.pointwise_module.module.cross_encoder.children())[2].parameters(), "lr": lr[4]},

            {'params': model.module.pointwise_module.module.encode_linear.parameters(), 'lr': lr[5]}
        ]
